...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class DomainDeleteDomainResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'Rouda\\OpenProvider\\Api\\Model\\DomainDeleteDomainResponse';
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === 'Rouda\\OpenProvider\\Api\\Model\\DomainDeleteDomainResponse';
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            $object = new \Rouda\OpenProvider\Api\Model\DomainDeleteDomainResponse();
            ...
            if (\array_key_exists('data', $data) && $data['data'] !== null) {
                $object->setData($this->denormalizer->denormalize($data['data'], 'Rouda\\OpenProvider\\Api\\Model\\DomainDeleteDomainResponseData', 'json', $context));
            }
        ...
        {
            return ['Rouda\\OpenProvider\\Api\\Model\\DomainDeleteDomainResponse' => false];
        }
    }
} else {
    class DomainDeleteDomainResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
