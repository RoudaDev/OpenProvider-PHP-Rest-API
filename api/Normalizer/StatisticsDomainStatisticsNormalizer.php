...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class StatisticsDomainStatisticsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'Rouda\\OpenProvider\\Api\\Model\\StatisticsDomainStatistics';
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === 'Rouda\\OpenProvider\\Api\\Model\\StatisticsDomainStatistics';
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            $object = new \Rouda\OpenProvider\Api\Model\StatisticsDomainStatistics();
            if (null === $data || false === \is_array($data)) {
                return $object;
            }
            if (\array_key_exists('by_status', $data) && $data['by_status'] !== null) {
                $object->setByStatus($this->denormalizer->denormalize($data['by_status'], 'Rouda\\OpenProvider\\Api\\Model\\StatisticsDomainStatisticsByStatus', 'json', $context));
            }
        ...
        {
            return ['Rouda\\OpenProvider\\Api\\Model\\StatisticsDomainStatistics' => false];
        }
    }
} else {
    class StatisticsDomainStatisticsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
