...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class LicenseExtendedLicenseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'Rouda\\OpenProvider\\Api\\Model\\LicenseExtendedLicense';
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === 'Rouda\\OpenProvider\\Api\\Model\\LicenseExtendedLicense';
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            $object = new \Rouda\OpenProvider\Api\Model\LicenseExtendedLicense();
            ...
            if (\array_key_exists('extensions', $data) && $data['extensions'] !== null) {
                ...
                foreach ($data['extensions'] as $value) {
                    $values[] = $this->denormalizer->denormalize($value, 'Rouda\\OpenProvider\\Api\\Model\\LicenseExtendedLicense', 'json', $context);
                }
            ...
            if (\array_key_exists('features', $data) && $data['features'] !== null) {
                ...
                foreach ($data['features'] as $value_1) {
                    $values_1[] = $this->denormalizer->denormalize($value_1, 'Rouda\\OpenProvider\\Api\\Model\\LicenseLicenseItem', 'json', $context);
                }
            ...
            if (\array_key_exists('key', $data) && $data['key'] !== null) {
                $object->setKey($this->denormalizer->denormalize($data['key'], 'Rouda\\OpenProvider\\Api\\Model\\LicenseKey', 'json', $context));
            }
        ...
        {
            return ['Rouda\\OpenProvider\\Api\\Model\\LicenseExtendedLicense' => false];
        }
    }
} else {
    class LicenseExtendedLicenseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
