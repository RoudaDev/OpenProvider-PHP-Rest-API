...
class CreateZone extends \Rouda\OpenProvider\Api\Runtime\Client\BaseEndpoint implements \Rouda\OpenProvider\Api\Runtime\Client\Endpoint
{
    /**
     * 
     *
     ...
     */
    public function __construct(\Rouda\OpenProvider\Api\Model\ZoneCreateZoneRequest $body)
    {
        $this->body = $body;
    }
