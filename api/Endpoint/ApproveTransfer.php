...
class ApproveTransfer extends \Rouda\OpenProvider\Api\Runtime\Client\BaseEndpoint implements \Rouda\OpenProvider\Api\Runtime\Client\Endpoint
{
    protected $id;
    /**
     * 
     ...
     */
    public function __construct(int $id, \Rouda\OpenProvider\Api\Model\DomainApproveTransferRequest $body)
    {
        $this->id = $id;
        $this->body = $body;
    }
