...
class SendFoa1 extends \Rouda\OpenProvider\Api\Runtime\Client\BaseEndpoint implements \Rouda\OpenProvider\Api\Runtime\Client\Endpoint
{
    protected $id;
    /**
     * 
     ...
     */
    public function __construct(int $id, \Rouda\OpenProvider\Api\Model\DomainSendFoa1Request $body)
    {
        $this->id = $id;
        $this->body = $body;
    }
    ...
    {
        return str_replace(['{id}'], [$this->id], '/v1beta/domains/{id}/transfer/send-foa1');
    }
