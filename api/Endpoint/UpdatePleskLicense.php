...
class UpdatePleskLicense extends \Rouda\OpenProvider\Api\Runtime\Client\BaseEndpoint implements \Rouda\OpenProvider\Api\Runtime\Client\Endpoint
{
    protected $key_id;
    /**
     * 
     ...
     */
    public function __construct(int $keyId, \Rouda\OpenProvider\Api\Model\LicenseUpdatePleskLicenseRequest $body)
    {
        $this->key_id = $keyId;
        $this->body = $body;
    }
