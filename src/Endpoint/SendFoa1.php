...
class SendFoa1 extends \Rouda\OpenProviderAPI\Runtime\Client\BaseEndpoint implements \Rouda\OpenProviderAPI\Runtime\Client\Endpoint
{
    protected $id;
    /**
     * 
     ...
     */
    public function __construct(int $id, \Rouda\OpenProviderAPI\Model\DomainSendFoa1Request $body)
    {
        $this->id = $id;
        $this->body = $body;
    }
