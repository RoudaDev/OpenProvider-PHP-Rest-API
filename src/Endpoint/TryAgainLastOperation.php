...
class TryAgainLastOperation extends \Rouda\OpenProviderAPI\Runtime\Client\BaseEndpoint implements \Rouda\OpenProviderAPI\Runtime\Client\Endpoint
{
    protected $id;
    /**
     * 
     ...
     */
    public function __construct(int $id, \Rouda\OpenProviderAPI\Model\DomainTryAgainLastOperationRequest $body)
    {
        $this->id = $id;
        $this->body = $body;
    }
