...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class TldPriceWithPromoInfoNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'Rouda\\OpenProviderAPI\\Model\\TldPriceWithPromoInfo';
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === 'Rouda\\OpenProviderAPI\\Model\\TldPriceWithPromoInfo';
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            $object = new \Rouda\OpenProviderAPI\Model\TldPriceWithPromoInfo();
            ...
            if (\array_key_exists('promotion_details', $data)) {
                $object->setPromotionDetails($this->denormalizer->denormalize($data['promotion_details'], 'Rouda\\OpenProviderAPI\\Model\\TldPromoDetails', 'json', $context));
            }
        ...
        {
            return ['Rouda\\OpenProviderAPI\\Model\\TldPriceWithPromoInfo' => false];
        }
    }
} else {
    class TldPriceWithPromoInfoNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
