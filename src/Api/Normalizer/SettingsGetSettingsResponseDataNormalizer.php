...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class SettingsGetSettingsResponseDataNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'Rouda\\OpenProvider\\Api\\Model\\SettingsGetSettingsResponseData';
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === 'Rouda\\OpenProvider\\Api\\Model\\SettingsGetSettingsResponseData';
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            $object = new \Rouda\OpenProvider\Api\Model\SettingsGetSettingsResponseData();
            ...
            if (\array_key_exists('signed_contracts', $data) && $data['signed_contracts'] !== null) {
                ...
                foreach ($data['signed_contracts'] as $value_4) {
                    $values_4[] = $this->denormalizer->denormalize($value_4, 'Rouda\\OpenProvider\\Api\\Model\\SettingsSignedContracts', 'json', $context);
                }
        ...
        {
            return ['Rouda\\OpenProvider\\Api\\Model\\SettingsGetSettingsResponseData' => false];
        }
    }
} else {
    class SettingsGetSettingsResponseDataNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
