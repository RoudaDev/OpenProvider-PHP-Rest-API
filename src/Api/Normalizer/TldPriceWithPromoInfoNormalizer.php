...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class TldPriceWithPromoInfoNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'Rouda\\OpenProvider\\Api\\Model\\TldPriceWithPromoInfo';
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === 'Rouda\\OpenProvider\\Api\\Model\\TldPriceWithPromoInfo';
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            $object = new \Rouda\OpenProvider\Api\Model\TldPriceWithPromoInfo();
            if (null === $data || false === \is_array($data)) {
                return $object;
            }
            if (\array_key_exists('product', $data) && $data['product'] !== null) {
                $object->setProduct($this->denormalizer->denormalize($data['product'], 'Rouda\\OpenProvider\\Api\\Model\\TldPriceInCurrency', 'json', $context));
            }
            ...
            if (\array_key_exists('promotion_details', $data) && $data['promotion_details'] !== null) {
                $object->setPromotionDetails($this->denormalizer->denormalize($data['promotion_details'], 'Rouda\\OpenProvider\\Api\\Model\\TldPromoDetails', 'json', $context));
            }
            ...
            if (\array_key_exists('reseller', $data) && $data['reseller'] !== null) {
                $object->setReseller($this->denormalizer->denormalize($data['reseller'], 'Rouda\\OpenProvider\\Api\\Model\\TldPriceInCurrency', 'json', $context));
            }
        ...
        public function normalize(mixed $object, string $format = null, array $context = []) : array|string|int|float|bool|\ArrayObject|null
        {
            ...
            if ($object->isInitialized('promotionDetails') && null !== $object->getPromotionDetails()) {
        ...
        {
            return ['Rouda\\OpenProvider\\Api\\Model\\TldPriceWithPromoInfo' => false];
        }
    }
} else {
    class TldPriceWithPromoInfoNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
