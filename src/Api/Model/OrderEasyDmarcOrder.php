...
class OrderEasyDmarcOrder
{
     ...
     * @var string|null
     */
    protected $easydmarcEmailAddress;
    /**
     * 
     *
     * @var string|null
     ...
     * 
     *
     * @var OrderRecentEasyDmarcAction|null
     */
    protected $recentEasydmarcAction;
    /**
     * 
     *
     * @var string|null
     ...
     * @return string|null
     */
    public function getEasydmarcEmailAddress() : ?string
    {
        return $this->easydmarcEmailAddress;
    }
    /**
     * 
     *
     * @param string|null $easydmarcEmailAddress
     *
     * @return self
     */
    public function setEasydmarcEmailAddress(?string $easydmarcEmailAddress) : self
    {
        $this->initialized['easydmarcEmailAddress'] = true;
        $this->easydmarcEmailAddress = $easydmarcEmailAddress;
        return $this;
    }
    /**
     * 
     ...
     * 
     *
     * @return OrderRecentEasyDmarcAction|null
     */
    public function getRecentEasydmarcAction() : ?OrderRecentEasyDmarcAction
    {
        return $this->recentEasydmarcAction;
    }
    /**
     * 
     *
     * @param OrderRecentEasyDmarcAction|null $recentEasydmarcAction
     *
     * @return self
     */
    public function setRecentEasydmarcAction(?OrderRecentEasyDmarcAction $recentEasydmarcAction) : self
    {
        $this->initialized['recentEasydmarcAction'] = true;
        $this->recentEasydmarcAction = $recentEasydmarcAction;
        return $this;
    }
    /**
     * 
